...
class AllItemsInCategory extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AllItemsInCategory', createEmptyInstance: create)
    ..pc<Item>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'items', $pb.PbFieldType.PM, subBuilder: Item.create)
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'categoryID', $pb.PbFieldType.O3, protoName: 'categoryID')
    ..hasRequiredFields = false
  ;

  AllItemsInCategory._() : super();
  factory AllItemsInCategory({
    $core.Iterable<Item>? items,
    $core.int? categoryID,
  }) {
    final _result = create();
  ...
  factory AllItemsInCategory.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory AllItemsInCategory.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  AllItemsInCategory clone() => AllItemsInCategory()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AllItemsInCategory copyWith(void Function(AllItemsInCategory) updates) => super.copyWith((message) => updates(message as AllItemsInCategory)) as AllItemsInCategory; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static AllItemsInCategory create() => AllItemsInCategory._();
  AllItemsInCategory createEmptyInstance() => create();
  static $pb.PbList<AllItemsInCategory> createRepeated() => $pb.PbList<AllItemsInCategory>();
  @$core.pragma('dart2js:noInline')
  static AllItemsInCategory getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AllItemsInCategory>(create);
  static AllItemsInCategory? _defaultInstance;
